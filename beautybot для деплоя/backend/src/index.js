...
// Detect if running from root (Railway) or from backend directory
const isRootDeploy = require('fs').existsSync(path.join(__dirname, '..', '..', 'frontend')) &&
                     !require('fs').existsSync(path.join(__dirname, '..', 'frontend'));
const FRONTEND_PATH = path.resolve(__dirname, '..', '..', 'frontend');
const DB_PATH_ENV = process.env.DB_PATH || './data/beauty_salon.db';
const DB_PATH = path.resolve(__dirname, '..', DB_PATH_ENV);
const UPLOADS_PATH_ENV = process.env.UPLOADS_PATH || './uploads';
const UPLOADS_PATH = path.resolve(__dirname, '..', UPLOADS_PATH_ENV);
